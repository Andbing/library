...
public class SPUtils {
    ...
    public static void saveObject(Context context, String key, Object obj) {
        try {
            ...
            e.printStackTrace();
            LUtil.error("save object error...  --> " + obj.getClass().getSimpleName());
        }
    }
    ...
    public static Object readObject(Context context, String key) {
        try {
            SharedPreferences editor = context.getSharedPreferences(FILE_NAME, 0);
            if (editor.contains(key)) {
                String string = editor.getString(key, "");
